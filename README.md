...
+ 查询用户绑卡记录 [queryBankCards](https://github.com/bravist/cnvex/blob/master/src/Api.php)
+ 绑定对私银行卡 [bindPrivateBankCard](https://github.com/bravist/cnvex/blob/master/src/Api.php)
+ 绑定对公/对公&&对私银行卡 [bindPublicBankCard](https://github.com/bravist/cnvex/blob/master/src/Api.php)
+ 解绑银行卡 [unbindBankCard](https://github.com/bravist/cnvex/blob/master/src/Api.php)
